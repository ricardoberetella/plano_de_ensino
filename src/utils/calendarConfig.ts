...
export const INITIAL_SCHOOL_EVENTS_2026: SchoolCalendarEvent[] = [
  ...
  { id: "e-2-4", date: "2026-08-01", title: "Sábado de Compensação (do dia 10/07)", type: "compensacao", balanceForDayOfWeek: 5 },
  ...
  { id: "e-2-8", date: "2026-08-22", title: "Sábado de Compensação (do dia 07/08)", type: "compensacao", balanceForDayOfWeek: 5 },
  ...
  { id: "e-2-12", date: "2026-10-03", title: "Sábado de Compensação (do dia 07/08)", type: "compensacao", balanceForDayOfWeek: 5 },
